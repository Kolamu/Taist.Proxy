...
public class CertFactory {
	public static byte[] readCertifacates() throws Exception{  
        ...
        InputStream in=new FileInputStream("c:/taist.crt");  
    ...
    public static byte[] readPrivateKey() throws  Exception{  
        ...
        InputStream in=new FileInputStream("c:/taist.proxy");  
        store.load(in,"taist.proxy".toCharArray());  
        PrivateKey pk=(PrivateKey)store.getKey("taist.proxy","taist.proxy".toCharArray());  
